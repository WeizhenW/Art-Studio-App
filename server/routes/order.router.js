...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const orderInsertResults = await client.query(`INSERT INTO "orders" ("name", "street", "city", "zip", "state", "type", "total")
        VALUES ($1, $2, $3, $4, $5, $6, $7)
        RETURNING id;`, [name, street, city, zip, state, type, total]);
